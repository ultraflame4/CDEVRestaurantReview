...
import {RecommendedNearbyItem, RecommendedPopularItem} from "@/components/RecommendedBanner/RecommendedItems";
...
export default defComponent((props) => {
    ...
    useEffect(() => {
        ...
        GetRestaurants(0, 1, 1, 6).then(value => {
            setTopRestaurants(value)
        })
        ...
        <main>
            <section id={"recommendations-banner"}>
                <div>
                    ...
                    <div id={"top-rated-list"} className={"card"}>
                        <h2>Top rated</h2>
                        <ul>
                            {
                                topRestaurants.map((value, index) =>
                                    <RecommendedPopularItem
                                        key={index}
                                        id={value.id}
                                        tags={value.tags}
                                        rating={parseFloat(value.avg_rating)}
